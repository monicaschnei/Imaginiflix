        ...
        <nav className='navbar absolute top-0 left-0 grid grid-cols-2 items-center w-full p-8'>
            ...
            <div className='justify-self-end flex justify-items-end items-center'>
                <form className='relative w-64 '>
                    ...
                    <button 
                    className='search absolute right-0 px-2 py-1' 
                ...
                <div className='relative flex ml-4'>
                   ...
                   <ul className={`absolute right-0 mt-10  top-0 w-32 bg-black rounded p-4 transition-all duration-500 ease-in-out ${!isMenuOpen && 'opacity-0 invisible'}`}>
                        <li>
